...
import smsConfig from 'src/sms/config/sms.config';
...
function generateModulesSet() {
  ...
  const mongodbModule = MongooseModule.forRootAsync({
    ...
    useFactory: (configService: ConfigService<AllConfigType>) => ({
      uri: configService.getOrThrow('database.url', { infer: true }),
      tls: configService.get('database.tlsEnabled', { infer: true }),
