...
@QueueEventsListener(QueueName.SMS, { blockingTimeout: 300000 })
export class SmsQueueEvents extends QueueEventsHost {
  private readonly logger = new Logger(SmsQueueEvents.name);
