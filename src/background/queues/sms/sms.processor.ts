import { IEmailJob, IVerifySmsJob } from '@/common/interfaces/job.interface';
...
export class SmsProcessor extends WorkerHost {
  ...
  async process(
    ...
    switch (job.name) {
      case JobName.SMS_VERIFICATION:
        return await this.smsQueueService.sendSmsVerification(
          job.data as unknown as IVerifySmsJob,
        );
        break;
      default:
